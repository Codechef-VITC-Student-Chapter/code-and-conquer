  ...
  return (
    <div
      ...
      <div id="faqs" className="text-white text-7xl h-full flex flex-col items-center justify-center">
        ...
        <FAQBox question={"🚀 New to Web Development and Cybersecurity?  🚀"} answer={"Yes, you can absolutely take part in this event! 🌟 We’ve got a series of completely free online events preceding the main event to get you up to speed, check the time line above and got click on the big blue register button 😉"}></FAQBox>
